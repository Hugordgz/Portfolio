...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/in/hugorodtris',
      icon: (
    ...
    {
      name: 'Email',
      url: 'mailto:hugorodtris@gmail.com',
      icon: (
      ...
      <div className="container-max section-padding py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/projects" className="text-secondary-300 hover:text-white transition-colors duration-200">
                  Projects
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-secondary-700 mt-8 pt-8 text-center">
          <p className="text-secondary-400">
            © {currentYear} Hugo Rodriguez Tristancho. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
